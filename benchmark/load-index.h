...
class Factory {
 public:
  ...
  std::pair<std::shared_ptr<ri::SearchIndex>, std::size_t> make(const Config &t_config) const {
 ...
 private:
  ...
  std::pair<std::shared_ptr<ri::SearchIndex>, std::size_t> internal_make(const Config &t_config) const {
